...
async function getSummaryTable() {
  ...
  return investments.map((i) => {
    ...
    return {
      ...
      units: i.units != null ? Number(i.units) : i.units,
      nav_price: i.nav_price != null ? Number(i.nav_price) : i.nav_price,
      nav_source: i.nav_source || null,
      mutual_fund_scheme_name: i.mutual_fund_scheme_name || null,
      avg_buy_price: i.avg_buy_price != null ? Number(i.avg_buy_price) : i.avg_buy_price,
      invested_amount: i.invested_amount != null ? Number(i.invested_amount) : i.invested_amount,
      profit_loss: i.profit_loss != null ? Number(i.profit_loss) : i.profit_loss,
      mutual_fund_scheme_code: i.mutual_fund_scheme_code || null,
